...
public static class PanoramicToCubemapRuntimeConverter
{
	...
	public static Cubemap ConvertPanoramaTextureToCubemap(Texture2D panoramicTexture, int cubemapResolution, byte superSamplingLevel = 2, TextureFormat cubeMapFormat = TextureFormat.RGBA32, bool generateMipMaps = true)
	{
		...
		if (!useMultiThreading)
		{
			...
			UnityEngine.Object.Destroy(CUBE_Left_Cache);
			UnityEngine.Object.Destroy(CUBE_Right_Cache);
			UnityEngine.Object.Destroy(CUBE_Forward_Cache);
			UnityEngine.Object.Destroy(CUBE_Backward_Cache);
			UnityEngine.Object.Destroy(CUBE_Top_Cache);
			UnityEngine.Object.Destroy(CUBE_Bottom_Cache);
